	...
	public boolean execute(ShellContext<DHT<String>> context) {
		...
		do {
			...
			for (int j = 1; j < nargs; j++) {
				System.out.println ("########## Enconding the ressource (PrivaNetValue: message + certificate) in base 64. ##########");
				String res = new PrivaNetValue (args[argIndex + j], context.getCertificate()).inBase64();
